 ...
 * Edit the original source file "tests/test_complements.checkmk" instead.
 */
...
START_TEST(s21_calc_complements_1) {
  ...
  ck_assert_int_eq(s21_calc_complements(&A, NULL), INCORR_MATRIX_ERROR);
  s21_remove_matrix(&A);
}
END_TEST
...
START_TEST(s21_calc_complements_2) {
  ...
  s21_fill_matrix(&A, 1, 3);
  ck_assert_int_eq(s21_calc_complements(&A, &result), MATH_ERROR);
  s21_remove_matrix(&A);
}
END_TEST
...
int test_complements_main(void) {
  Suite *s1 = suite_create("COMPLEMENTS");
  TCase *tc1_1 = tcase_create("COMPLEMENTS");
  ...
  tcase_add_test(tc1_1, s21_calc_complements_8);
  tcase_add_test(tc1_1, s21_calc_complements_9);
  tcase_add_test(tc1_1, s21_calc_complements_10);
