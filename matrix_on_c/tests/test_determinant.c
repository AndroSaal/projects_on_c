 ...
 * Edit the original source file "tests/test_determinant.checkmk" instead.
 */
...
START_TEST(s21_determinant_1) {
  ...
  // printf("Матрица исходная 16 :\n");
  // print_matrix(A);
  ck_assert_int_eq(s21_determinant(&A, &det), MATH_ERROR);
  s21_remove_matrix(&A);
}
END_TEST
...
int test_determinant_main(void) {
  Suite *s1 = suite_create("tests determinant");
  TCase *tc1_1 = tcase_create("tests determinant");
  ...
  tcase_add_test(tc1_1, s21_determinant_12);
